...
async def main() -> int:
    ...
    creds = [
        ...
        SecretValues(
            _Conn(name=slug_conn_name + "-mgmt", secrets=supabase_mgmt.secrets,
                  base_url=supabase_mgmt.base_url, auth_header_name=supabase_mgmt.auth_header_name,
                  auth_header_format=supabase_mgmt.auth_header_format),
